...
namespace SteerStone { namespace Core { namespace Logger { 
    ...
    public:
        ...
        template<class... Args> void Report(LogType p_Type, const std::string& p_System, std::string const p_Function, int32 const p_FunctionLine, const std::string& p_Message, Args ...p_Args)
        {
        ...
        /// @p_FunctionLine : Function line of caller
        /// @p_Message      : Message to report
        void Report(LogType p_LogType, std::string const& p_System, std::string const p_Function, int32 const p_FunctionLine, std::string const& p_Message);
        /// Report assert message
        /// @p_System       : Message sender
        /// @p_Function     : Function name of caller
        /// @p_FunctionLine : Function line of caller
        /// @p_Message      : Message to report
        void ReportAssert(std::string const& p_System, std::string const p_Function, int32 const p_FunctionLine, std::string const& p_Message);
