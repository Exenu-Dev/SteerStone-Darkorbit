...
int main()
{
    ...
    if (!sConfigManager->SetFile("policy.conf"))
        return -1;
    ...
    static const int32 l_Port                   = sConfigManager->GetInt("PolicyPort", 843);
    ...
    LOG_INFO("Policy", "Policy Server successfully booted, listening on %0 %1", l_Address, l_Port);
