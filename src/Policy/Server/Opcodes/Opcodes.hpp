...
namespace SteerStone { namespace Policy { namespace Server {
    ...
    struct OpcodeHandler
    {
        ...
        void (PolicySocket::*Handler)(ClientPacket* p_Packet);
    };
    ...
    class OpCodes
    {
        ...
        private:
            ...
            void StoreClientPacket(uint64 const p_OpCode, char const* p_Name, PacketStatus const p_Status, PacketProcess p_Process, void (PolicySocket::*handler)(ClientPacket* p_Packet));
            /// Store Server packet into storage
            /// @p_Opcode : Opcode Id
            /// @p_Name : Name of Opcode
            /// @p_Handler : Handler Function which we will be accessing too
            void StoreServerPacket(uint64 const p_OpCode, char const* p_Name, void (PolicySocket::* p_Handler)(ClientPacket* p_Packet));
...
#define sOpCode SteerStone::Policy::Server::OpCodes::GetSingleton()